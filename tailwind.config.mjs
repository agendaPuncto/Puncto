...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Brand Primary - Deep Purple (Trust, Innovation)
        primary: {
          50: '#EEF2FF',
          100: '#E0E7FF',
          200: '#C7D2FE',
        ...
        // Brand Secondary - Teal (Growth, Health)
        secondary: {
          50: '#F0FDFA',
          100: '#CCFBF1',
          200: '#99F6E4',
      ...
      backgroundImage: {
        ...
        'gradient-brand': 'linear-gradient(135deg, #6366F1 0%, #4F46E5 50%, #14B8A6 100%)',
        'gradient-hero': 'linear-gradient(135deg, #EEF2FF 0%, #F0FDFA 100%)',
